...
namespace DoctorsOnline.Controllers
{
    public class OrganizationsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include="Id,OrganizationName,Phone,Email")] Organization organization)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include="Id,OrganizationName,Phone,Email")] Organization organization)
        {
            if (ModelState.IsValid)
            {
